...
RSpec.describe Backlogs::BucketComponent, type: :component do
  ...
  context "when the user lacks the manage_sprint_items permission" do
    ...
    it "does not mark work package rows as draggable" do
      ...
      expect(rendered_component).to have_no_css(".op-backlogs-story[data-sortable-lists--item-id-value]")
      expect(rendered_component).to have_no_css(".op-backlogs-story[data-sortable-lists--item-target]")
      expect(rendered_component).to have_no_css(".op-backlogs-story[data-sortable-lists--item-move-url-value]")
