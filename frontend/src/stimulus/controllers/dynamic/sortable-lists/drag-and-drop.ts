...
export const sortableItemKeyboardDropEvent = 'sortable-lists:item-keyboard-drop';
...
export interface SortableItemKeyboardDropDetail {
...
export function buildMoveFormData({
  ...
  data.append('prev_item_id', previousItemId ?? '');
